...
class Dokumen extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['datas']	= $this->db_model->list_dok()->result_object();
		// $data['datas']	= $this->db->query("select * from tb_dokumen  WHERE YEAR(tanggal_berangkat)=2020 order by id_doc DESC ")->result_object();
	...
	public function add_dokumen()
	{
		...
		$this->load->view('admin/templates/header', $data);
		$this->load->view('admin/templates/sidebar', $data);
		$this->load->view('admin/page_dokumen_add', $data);
		$this->load->view('admin/templates/footer');
	}
	...
	public function cetak_dokumen_vdua($id_doc){
		//echo $id_doc;
		$data['user'] = $this->db->get_where('tbl_users', ['email' => $this->session->userdata('emaila')])->row_array();
		$data = $this->db->query("select * from tb_dokumen where id_doc=".$id_doc)->result_array();
		$data['kelas']	= $this->db->query("select * from tb_class")->result_object();
		...
		$this->load->view('admin/templates/sidebar', $data);
		$this->load->view('admin/page_dokumen', $data);
		$this->load->view('admin/page_surattugas_v2', $data);
		$this->load->view('admin/templates/footer');
	}
	...
	public function cetak_sppd($id_doc){
		...
		// $this->load->view('admin/page_surattugas_supllier', $data);
		$this->load->view('admin/templates/footer');

	}

	public function cetak_spd($id_doc){
		//echo $id_doc;
		$data = $this->db->query("select * from tb_dokumen where id_doc=".$id_doc)->result_array();
		$data['kelas']	= $this->db->query("select * from tb_class")->result_object();
		$this->db->select('*');
		...
		$this->load->view('admin/templates/header', $data);
		$this->load->view('admin/templates/sidebar', $data);
		$this->load->view('admin/page_spd', $data);
		$this->load->view('admin/page_spd_master', $data);
		// $this->load->view('admin/page_surattugas_supplier', $data);
		$this->load->view('admin/templates/footer');
  ...
  <tr>
   ...
   <tr>
	...
	Generate Email From STONLINE Balai KIPM Semarang		
		...
		$fields['email'] 	= "rmutiaray@gmail.com";
		$fields['subject'] 	= "Subjek";
		$fields['name'] 	= "Rizky Mutiara";
	...
	public function submit()
	{
		...
		//  $cek = $this->db_model->insert_dokumen($data);	 
		//  if ($cek!=1) {			  
