            ...
            <div class="page-content">
				...
				<div class="row">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo base_url(); ?>laporan/filterdate" enctype="multipart/form-data">
                        ...
                        <div class="pull-left">
                            Tanggal Berangkat:
                            <input type="text" class="form-control pull-left" name='tanggal_berangkat' id="datemask">
                        </div>

                        <div class="pull-left">
                            Tanggal Pulang:
                            <input type="text" class="form-control pull-right" name='tanggal_pulang' id="datemask2">
                        </div>
                        <div class="pull-left">
                            Filter
                            <br>
