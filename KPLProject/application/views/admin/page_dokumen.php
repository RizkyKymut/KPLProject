                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <input type="text" class="form-control" name='nosurat' placeholder="Enter..." value="<?= $nosurat?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-1 col-xs-1 control-label">Pulang</label>   
                                                <div class="col-md-3 col-xs-2">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                    ...
                    <div class="panel-body">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th width="10%"><center>Menimbang</th>
                                
                                <th ><center>Deskripsi Surat Tugas</th>
                                <th ><center>Deskripsi Tujuan</th>
                                <th ><center>Tanggal Berangkat</th>
                                <th ><center>Tanggal Pulang</th>
                                
    
                                <th width="15%"><center>Status Surat Tugas</th>
                                <th align="center" width="15%"><center>Aksi</th>
							...
							<span class=\"label label-primary\"><i class=\"fa fa-eye\"></i> view</span>
                                        ...
                                        <td align="center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <button>
                                                    <a href="<?php echo base_url(); ?>dokumen/cetak_dokumen_vdua/<?php echo $row->id_doc;?>" 
