      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('Dokumen'); ?>"><i class="fa fa-circle-o"></i> Umum </a></li>
          </ul>
          <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('Laporan'); ?>"><i class="fa fa-circle-o"></i> Laporan </a></li>
            <li class="active"><a href="<?php echo base_url('Sppd'); ?>"><i class="fa fa-circle-o"></i> SPPD </a></li>
            <li class="active"><a href="<?php echo base_url('Spd'); ?>"><i class="fa fa-circle-o"></i> SPD </a></li>
          </ul>
          <li class="treeview">
          <a href="#">
